...
import { View, StyleSheet, Text, StatusBar, ImageBackground, TextInput } from 'react-native';
    ...
    return (
        <ImageBackground source={homeScreen} style={{ flex: 1 }}>
            ...
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ borderWidth: 1, alignItems: 'center', justifyContent: 'center', height: '10%', width: '100%' }}>
