...
export const HOST_CRAWL = `https://travel-api-tour.onrender.com`;
...
export const getSliderRoute = `${HOST_CRAWL}/api/get-slider`;
export const getToursLastHourRoute = `${HOST_CRAWL}/api/get-tours`;
export const getAllPlaceForNameRoute = `${HOST_CRAWL}/api/get-place-aspx`;
export const getDetailRoute = `${HOST_CRAWL}/api/get-detail-next`;
